...
public class Model_Auftrag {
	...
	public Map<String, String> getDataFromAuftrag(int id) {
		try {
			Map<String, String[]> auftrag = Connector.getQueryResult(
					"SELECT auftrag.auftragId,auftrag.entfernung,auftrag.datumDerFahrt,auftrag.letztesÄnderungsDatum,auftrag.entfernung, "
							+ "ziel.plz as zielPlz,ziel.stadt as zielStadt,ziel.straße as zielStraße,ziel.hausnummer as zielHausnummer,ziel.adresszusatz as zielAdresszusatz, "
							+ "startAdresse.plz as startPlz,startAdresse.stadt as startStadt,startAdresse.straße as startStraße,startAdresse.hausnummer as startHausnummer,startAdresse.adresszusatz as startAdresszusatz, "
			...
			try {
				...
				mapResult.put("startStraße", auftrag.get("startStraße")[0]);
				...
				mapResult.put("zielStraße", auftrag.get("zielStraße")[0]);
		...
		try {
			...
			if (hasChanged(data, auftrag, "startPlz") || hasChanged(data, auftrag, "startOrt")
				...
				int startAdressIdTmp = Connector
						.insertIntoTable("INSERT INTO `adresse`(`plz`, `stadt`, `straße`, `hausnummer`,`lat`,`lon`) "
	...
	public Map<String, String> getCustomerAdress(int id) {
		try {
			...
			data.put("street", kunde.get("straße")[0]);
